...
// Property Listings Routes (user submissions)
Route::prefix('property-listings')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/{id}/status', [PropertyListingController::class, 'updateStatus']);
...
Route::prefix('users')->group(function () {
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/{id}', [UserController::class, 'update']); // Accept POST for method spoofing
        Route::put('/{id}', [UserController::class, 'update']); // Also accept PUT for direct calls
        Route::delete('/{id}', [UserController::class, 'destroy']);
        Route::post('/{id}/ban', [UserController::class, 'ban']);
        Route::post('/{id}/unban', [UserController::class, 'unban']);
        
        // Permission management routes
        Route::get('/{id}/permissions', [PermissionController::class, 'getUserPermissions']);
        Route::post('/{id}/roles', [PermissionController::class, 'assignRole']);
        Route::delete('/{id}/roles', [PermissionController::class, 'removeRole']);
        Route::post('/{id}/permissions', [PermissionController::class, 'assignPermission']);
        Route::delete('/{id}/permissions', [PermissionController::class, 'removePermission']);
        Route::put('/{id}/roles', [PermissionController::class, 'syncRoles']);
        Route::put('/{id}/permissions', [PermissionController::class, 'syncPermissions']);
    });
});
...
Route::prefix('roles')->middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/{id}', [RoleController::class, 'update']); // Accept POST for method spoofing
